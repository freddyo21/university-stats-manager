                    ...
                    <div className="flex shrink-0 items-center gap-2">
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button variant="outline" size="sm" className="h-8" aria-label={t("common.preset.DEFAULT")}>
                                    {t("common.preset.DEFAULT")}: {t(`common.preset.${state.presetId}`)}
                                </Button>
                            </DropdownMenuTrigger>
                            <DropdownMenuContent align="end" className="w-85">
                                <DropdownMenuLabel>{t("common.preset.DEFAULT")}</DropdownMenuLabel>
                                <DropdownMenuSeparator />
                                {listPresets().map((p) => (
